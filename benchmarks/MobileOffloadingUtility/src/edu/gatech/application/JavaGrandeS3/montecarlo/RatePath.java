...
package edu.gatech.application.JavaGrandeS3.montecarlo;
...
public class RatePath extends PathId {
  ...
  private void readRatesFile(String dirName, String filename) throws DemoException {
    ...
    iLine=0;
    for( java.util.Enumeration enumX = allLines.elements(); enumX.hasMoreElements(); ) {
      aLine = (String) enumX.nextElement();
