...
import edu.gatech.application.JavaGrandeS2.sor.SOR;
...
public class JavaGrandeSOR implements Serializable{
	...
	public JavaGrandeSOR(ClientExecutionController ec, OffloadingMode off){
		exectl = ec;
		offMode = off;
	...
	public void workBi(int noUse){
		...
		RemoteProxyWrapper<JavaGrandeSOR> wrap = new RemoteProxyWrapper<JavaGrandeSOR>(true); // assume call static method from client
		wrap.callRemote(this, "readSomeMagicNumber", 0);
	}
	
	public void workLocally(int noUse){
		SOR.SORrun(1.25, G, 10);
	}
