...
import edu.gatech.mcc.stabilization.MCCFactoryMotion2D;
...
//		Utility.logPrefix = "Mosaic ";
	...
	private StitchingFromMotion2D<ImageUInt8,Affine2D_F64> createStabilization() {
		...
		MCCFactoryMotion2D.res = this.getAssets();

		ImageMotion2D<ImageUInt8,Affine2D_F64> motion = MCCFactoryMotion2D.mccCreateMotion2D(100, 1.5, 2, 40,
