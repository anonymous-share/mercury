...
public class Utils {
	...
	public final static String IGNORE_NETWORK_TRANSFER_TIME = "mcc.ignoreTransfer";
	public final static String PSEUDO_FLOW_PATH = "mcc.path.flowsolver";
	...
	public static String readStringUntilHashTag(DataInputStream r) throws IOException{
